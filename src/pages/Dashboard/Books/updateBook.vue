        ...
        <form @submit.prevent="onSubmit"
            ...
            <div class="form-group">
                ...
                <input v-model.trim="genre"
                    class="form-input"
                    id="genre" type="text" :disabled="true" placeholder="Enter genre" />
            </div>
            <div class="form-group">
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            async onSubmit() {
                if (!this.hasErrors) {
                    ...
                    const res = await BooksAPI.updateBook(this.id, {name: this.name, description: this.description, price: this.price, pages: this.pages, capacity: this.capacity, capacitySold: this.capacitySold, authorIndices: this.getAuthorsIndexes});
        ...
        async mounted() {
            ...
            if (bookRes && bookRes.data) {
                ({name: this.name, description: this.description, price: this.price, genre: this.genre, pages: this.pages, capacity: this.capacity, capacitySold: this.capacitySold} = bookRes.data);
            }
